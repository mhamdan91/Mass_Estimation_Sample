...
def predictor(Network_size=None, Batch_size=8, train_mode = 0, epochs_= 10, visualize=True):
    ...
    if Network_size == 16:
        ...
        print('model was successfully constructed!')
